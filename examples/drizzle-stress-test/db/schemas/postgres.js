...
exports.postgresSchema = exports.tasksRelations = exports.projectsRelations = exports.usersRelations = exports.organizationsRelations = exports.tasks = exports.projects = exports.users = exports.organizations = void 0;
...
exports.projects = (0, pg_core_1.pgTable)('projects', {
    ...
    organizationId: (0, pg_core_1.integer)('organization_id').notNull().references(() => exports.organizations.id),
});
exports.tasks = (0, pg_core_1.pgTable)('tasks', {
    ...
    parentTaskId: (0, pg_core_1.integer)('parent_task_id'),
